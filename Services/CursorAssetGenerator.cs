...
public sealed class CursorAssetGenerator
{
    ...
    [
        ...
        new("lightsaber", "Lightsaber", "A glowing saber pointer with configurable blade color.", "Sci-Fi", 5, 5, new ClickEffect { Type = "Saber Glow", PrimaryColor = "#55F7FF", SecondaryColor = "#FFFFFF", ParticleCount = 3, Radius = 0, DurationMs = 450 }, "#55F7FF"),
        ...
        new("omnitrix", "Omnitrix", "A green alien-tech emblem cursor with pulse rings.", "Sci-Fi", 24, 24, new ClickEffect { Type = "Omnitrix Pulse", PrimaryColor = "#FF2020", SecondaryColor = "#FF4040", ParticleCount = 3, Radius = 0, DurationMs = 450 }),
